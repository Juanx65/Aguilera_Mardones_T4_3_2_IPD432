...
architecture behave of eucHW_control_s_axi is
    ...
    constant ADDR_Y_SQRT_DATA_0 : INTEGER := 16#0010#;
    constant ADDR_Y_SQRT_CTRL   : INTEGER := 16#0014#;
    constant ADDR_X_0_BASE      : INTEGER := 16#0100#;
    constant ADDR_X_0_HIGH      : INTEGER := 16#01ff#;
    constant ADDR_X_1_BASE      : INTEGER := 16#0200#;
    constant ADDR_X_1_HIGH      : INTEGER := 16#02ff#;
    constant ADDR_X_2_BASE      : INTEGER := 16#0300#;
    constant ADDR_X_2_HIGH      : INTEGER := 16#03ff#;
    constant ADDR_X_3_BASE      : INTEGER := 16#0400#;
    constant ADDR_X_3_HIGH      : INTEGER := 16#04ff#;
    constant ADDR_X_4_BASE      : INTEGER := 16#0500#;
    constant ADDR_X_4_HIGH      : INTEGER := 16#05ff#;
    constant ADDR_X_5_BASE      : INTEGER := 16#0600#;
    constant ADDR_X_5_HIGH      : INTEGER := 16#06ff#;
    constant ADDR_X_6_BASE      : INTEGER := 16#0700#;
    constant ADDR_X_6_HIGH      : INTEGER := 16#07ff#;
    constant ADDR_X_7_BASE      : INTEGER := 16#0800#;
    constant ADDR_X_7_HIGH      : INTEGER := 16#08ff#;
    constant ADDR_X_8_BASE      : INTEGER := 16#0900#;
    constant ADDR_X_8_HIGH      : INTEGER := 16#09ff#;
    constant ADDR_X_9_BASE      : INTEGER := 16#0a00#;
    constant ADDR_X_9_HIGH      : INTEGER := 16#0aff#;
    constant ADDR_X_10_BASE     : INTEGER := 16#0b00#;
    constant ADDR_X_10_HIGH     : INTEGER := 16#0bff#;
    constant ADDR_X_11_BASE     : INTEGER := 16#0c00#;
    constant ADDR_X_11_HIGH     : INTEGER := 16#0cff#;
    constant ADDR_X_12_BASE     : INTEGER := 16#0d00#;
    constant ADDR_X_12_HIGH     : INTEGER := 16#0dff#;
    constant ADDR_X_13_BASE     : INTEGER := 16#0e00#;
    constant ADDR_X_13_HIGH     : INTEGER := 16#0eff#;
    constant ADDR_X_14_BASE     : INTEGER := 16#0f00#;
    constant ADDR_X_14_HIGH     : INTEGER := 16#0fff#;
    constant ADDR_X_15_BASE     : INTEGER := 16#1000#;
    constant ADDR_X_15_HIGH     : INTEGER := 16#10ff#;
    constant ADDR_X_16_BASE     : INTEGER := 16#1100#;
    constant ADDR_X_16_HIGH     : INTEGER := 16#11ff#;
    constant ADDR_X_17_BASE     : INTEGER := 16#1200#;
    constant ADDR_X_17_HIGH     : INTEGER := 16#12ff#;
    constant ADDR_X_18_BASE     : INTEGER := 16#1300#;
    constant ADDR_X_18_HIGH     : INTEGER := 16#13ff#;
    constant ADDR_X_19_BASE     : INTEGER := 16#1400#;
    constant ADDR_X_19_HIGH     : INTEGER := 16#14ff#;
    constant ADDR_X_20_BASE     : INTEGER := 16#1500#;
    constant ADDR_X_20_HIGH     : INTEGER := 16#15ff#;
    constant ADDR_X_21_BASE     : INTEGER := 16#1600#;
    constant ADDR_X_21_HIGH     : INTEGER := 16#16ff#;
    constant ADDR_X_22_BASE     : INTEGER := 16#1700#;
    constant ADDR_X_22_HIGH     : INTEGER := 16#17ff#;
    constant ADDR_X_23_BASE     : INTEGER := 16#1800#;
    constant ADDR_X_23_HIGH     : INTEGER := 16#18ff#;
    constant ADDR_X_24_BASE     : INTEGER := 16#1900#;
    constant ADDR_X_24_HIGH     : INTEGER := 16#19ff#;
    constant ADDR_X_25_BASE     : INTEGER := 16#1a00#;
    constant ADDR_X_25_HIGH     : INTEGER := 16#1aff#;
    constant ADDR_X_26_BASE     : INTEGER := 16#1b00#;
    constant ADDR_X_26_HIGH     : INTEGER := 16#1bff#;
    constant ADDR_X_27_BASE     : INTEGER := 16#1c00#;
    constant ADDR_X_27_HIGH     : INTEGER := 16#1cff#;
    constant ADDR_X_28_BASE     : INTEGER := 16#1d00#;
    constant ADDR_X_28_HIGH     : INTEGER := 16#1dff#;
    constant ADDR_X_29_BASE     : INTEGER := 16#1e00#;
    constant ADDR_X_29_HIGH     : INTEGER := 16#1eff#;
    constant ADDR_X_30_BASE     : INTEGER := 16#1f00#;
    constant ADDR_X_30_HIGH     : INTEGER := 16#1fff#;
    constant ADDR_X_31_BASE     : INTEGER := 16#2000#;
    constant ADDR_X_31_HIGH     : INTEGER := 16#20ff#;
    ...
    -- memory signals
    signal int_x_0_address0    : UNSIGNED(5 downto 0);
    signal int_x_0_ce0         : STD_LOGIC;
    signal int_x_0_q0          : UNSIGNED(31 downto 0);
    signal int_x_0_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_x_1_address0    : UNSIGNED(5 downto 0);
    signal int_x_1_ce0         : STD_LOGIC;
    signal int_x_1_q0          : UNSIGNED(31 downto 0);
    signal int_x_1_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_x_2_address0    : UNSIGNED(5 downto 0);
    signal int_x_2_ce0         : STD_LOGIC;
    signal int_x_2_q0          : UNSIGNED(31 downto 0);
    signal int_x_2_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_x_3_address0    : UNSIGNED(5 downto 0);
    signal int_x_3_ce0         : STD_LOGIC;
    signal int_x_3_q0          : UNSIGNED(31 downto 0);
    signal int_x_3_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_x_4_address0    : UNSIGNED(5 downto 0);
    signal int_x_4_ce0         : STD_LOGIC;
    signal int_x_4_q0          : UNSIGNED(31 downto 0);
    signal int_x_4_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_x_5_address0    : UNSIGNED(5 downto 0);
    signal int_x_5_ce0         : STD_LOGIC;
    signal int_x_5_q0          : UNSIGNED(31 downto 0);
    signal int_x_5_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_x_6_address0    : UNSIGNED(5 downto 0);
    signal int_x_6_ce0         : STD_LOGIC;
    signal int_x_6_q0          : UNSIGNED(31 downto 0);
    signal int_x_6_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_x_7_address0    : UNSIGNED(5 downto 0);
    signal int_x_7_ce0         : STD_LOGIC;
    signal int_x_7_q0          : UNSIGNED(31 downto 0);
    signal int_x_7_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_x_8_address0    : UNSIGNED(5 downto 0);
    signal int_x_8_ce0         : STD_LOGIC;
    signal int_x_8_q0          : UNSIGNED(31 downto 0);
    signal int_x_8_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_x_9_address0    : UNSIGNED(5 downto 0);
    signal int_x_9_ce0         : STD_LOGIC;
    signal int_x_9_q0          : UNSIGNED(31 downto 0);
    signal int_x_9_address1    : UNSIGNED(5 downto 0);
    ...
    signal int_x_10_address0   : UNSIGNED(5 downto 0);
    signal int_x_10_ce0        : STD_LOGIC;
    signal int_x_10_q0         : UNSIGNED(31 downto 0);
    signal int_x_10_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_11_address0   : UNSIGNED(5 downto 0);
    signal int_x_11_ce0        : STD_LOGIC;
    signal int_x_11_q0         : UNSIGNED(31 downto 0);
    signal int_x_11_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_12_address0   : UNSIGNED(5 downto 0);
    signal int_x_12_ce0        : STD_LOGIC;
    signal int_x_12_q0         : UNSIGNED(31 downto 0);
    signal int_x_12_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_13_address0   : UNSIGNED(5 downto 0);
    signal int_x_13_ce0        : STD_LOGIC;
    signal int_x_13_q0         : UNSIGNED(31 downto 0);
    signal int_x_13_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_14_address0   : UNSIGNED(5 downto 0);
    signal int_x_14_ce0        : STD_LOGIC;
    signal int_x_14_q0         : UNSIGNED(31 downto 0);
    signal int_x_14_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_15_address0   : UNSIGNED(5 downto 0);
    signal int_x_15_ce0        : STD_LOGIC;
    signal int_x_15_q0         : UNSIGNED(31 downto 0);
    signal int_x_15_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_16_address0   : UNSIGNED(5 downto 0);
    signal int_x_16_ce0        : STD_LOGIC;
    signal int_x_16_q0         : UNSIGNED(31 downto 0);
    signal int_x_16_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_17_address0   : UNSIGNED(5 downto 0);
    signal int_x_17_ce0        : STD_LOGIC;
    signal int_x_17_q0         : UNSIGNED(31 downto 0);
    signal int_x_17_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_18_address0   : UNSIGNED(5 downto 0);
    signal int_x_18_ce0        : STD_LOGIC;
    signal int_x_18_q0         : UNSIGNED(31 downto 0);
    signal int_x_18_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_19_address0   : UNSIGNED(5 downto 0);
    signal int_x_19_ce0        : STD_LOGIC;
    signal int_x_19_q0         : UNSIGNED(31 downto 0);
    signal int_x_19_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_20_address0   : UNSIGNED(5 downto 0);
    signal int_x_20_ce0        : STD_LOGIC;
    signal int_x_20_q0         : UNSIGNED(31 downto 0);
    signal int_x_20_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_21_address0   : UNSIGNED(5 downto 0);
    signal int_x_21_ce0        : STD_LOGIC;
    signal int_x_21_q0         : UNSIGNED(31 downto 0);
    signal int_x_21_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_22_address0   : UNSIGNED(5 downto 0);
    signal int_x_22_ce0        : STD_LOGIC;
    signal int_x_22_q0         : UNSIGNED(31 downto 0);
    signal int_x_22_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_23_address0   : UNSIGNED(5 downto 0);
    signal int_x_23_ce0        : STD_LOGIC;
    signal int_x_23_q0         : UNSIGNED(31 downto 0);
    signal int_x_23_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_24_address0   : UNSIGNED(5 downto 0);
    signal int_x_24_ce0        : STD_LOGIC;
    signal int_x_24_q0         : UNSIGNED(31 downto 0);
    signal int_x_24_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_25_address0   : UNSIGNED(5 downto 0);
    signal int_x_25_ce0        : STD_LOGIC;
    signal int_x_25_q0         : UNSIGNED(31 downto 0);
    signal int_x_25_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_26_address0   : UNSIGNED(5 downto 0);
    signal int_x_26_ce0        : STD_LOGIC;
    signal int_x_26_q0         : UNSIGNED(31 downto 0);
    signal int_x_26_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_27_address0   : UNSIGNED(5 downto 0);
    signal int_x_27_ce0        : STD_LOGIC;
    signal int_x_27_q0         : UNSIGNED(31 downto 0);
    signal int_x_27_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_28_address0   : UNSIGNED(5 downto 0);
    signal int_x_28_ce0        : STD_LOGIC;
    signal int_x_28_q0         : UNSIGNED(31 downto 0);
    signal int_x_28_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_29_address0   : UNSIGNED(5 downto 0);
    signal int_x_29_ce0        : STD_LOGIC;
    signal int_x_29_q0         : UNSIGNED(31 downto 0);
    signal int_x_29_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_30_address0   : UNSIGNED(5 downto 0);
    signal int_x_30_ce0        : STD_LOGIC;
    signal int_x_30_q0         : UNSIGNED(31 downto 0);
    signal int_x_30_address1   : UNSIGNED(5 downto 0);
    ...
    signal int_x_31_address0   : UNSIGNED(5 downto 0);
    signal int_x_31_ce0        : STD_LOGIC;
    signal int_x_31_q0         : UNSIGNED(31 downto 0);
    signal int_x_31_address1   : UNSIGNED(5 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    int_x_0_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_1_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_2_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_3_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_4_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_5_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_6_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_7_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_8_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_9_address1     <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_10_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_11_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_12_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_13_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_14_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_15_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_16_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_17_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_18_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_19_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_20_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_21_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_22_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_23_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_24_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_25_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_26_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_27_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_28_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_29_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_30_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
    ...
    int_x_31_address1    <= raddr(7 downto 2) when ar_hs = '1' else waddr(7 downto 2);
